          ...
          parameters:@{
             ...
             success:^(id resposeObject) {
                 ...
                 if ([resposeObject[@"code"] integerValue] ==200) {
                     ...
                     _data = @[@[[NSString stringWithFormat:@"推荐时间：%@",resposeObject[@"data"][@"create_time"]],[NSString stringWithFormat:@"到访时间：%@",resposeObject[@"data"][@"visit_time"]]],@[[NSString stringWithFormat:@"合同编号：%@",resposeObject[@"data"][@"contract_num"]],[NSString stringWithFormat:@"成交总价：%@元",resposeObject[@"data"][@"total_money"]],[NSString stringWithFormat:@"套内面积：%@㎡",resposeObject[@"data"][@"inner_area"]],[NSString stringWithFormat:@"成交时间：%@",resposeObject[@"data"][@"state_change_time"]]],@[[NSString stringWithFormat:@"客户姓名：%@",resposeObject[@"data"][@"name"]],sex,tel],@[[NSString stringWithFormat:@"项目名称：%@",resposeObject[@"data"][@"project_name"]],adress,[NSString stringWithFormat:@"物业类型：%@",[resposeObject[@"data"][@"property_type"] componentsJoinedByString:@","]]]];
