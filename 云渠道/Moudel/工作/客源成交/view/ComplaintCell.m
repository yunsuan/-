...
- (void)initUI{
    ...
    _nameL = [[UILabel alloc] initWithFrame:CGRectMake(10 *SIZE, 16 *SIZE, 100 *SIZE, 14 *SIZE)];
    _nameL.textColor = YJTitleLabColor;
    _nameL.font = [UIFont systemFontOfSize:15 *SIZE];
    [self.contentView addSubview:_nameL];
    
    _codeL = [[UILabel alloc] initWithFrame:CGRectMake(10 *SIZE, 43 *SIZE, 200 *SIZE, 11 *SIZE)];
    _codeL.textColor = YJ86Color;
    _codeL.font = [UIFont systemFontOfSize:12 *SIZE];
    [self.contentView addSubview:_codeL];
    
    _recomTimeL = [[UILabel alloc] initWithFrame:CGRectMake(10 *SIZE, 65 *SIZE, 170 *SIZE, 10 *SIZE)];
    ...
    _complainL = [[UILabel alloc] initWithFrame:CGRectMake(180 *SIZE, 67 *SIZE, 170 *SIZE, 10 *SIZE)];
    ...
    UIView *line = [[UIView alloc] initWithFrame:CGRectMake(0, 92 *SIZE, SCREEN_Width, SIZE)];
