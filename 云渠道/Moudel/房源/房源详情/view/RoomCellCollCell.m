...
- (void)initUI{
    ...
    _letterL = [[UILabel alloc] initWithFrame:CGRectMake(10 *SIZE, 144 *SIZE, 30 *SIZE, 11 *SIZE)];
    _letterL.textColor = YJTitleLabColor;
    _letterL.font = [UIFont systemFontOfSize:12 *SIZE];
    [self.contentView addSubview:_letterL];
    
    _areaL = [[UILabel alloc] initWithFrame:CGRectMake(64 *SIZE, 146 *SIZE, 40 *SIZE, 11 *SIZE)];
