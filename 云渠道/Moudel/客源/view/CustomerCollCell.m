...
- (void)initUI{
    ...
    _typeL = [[UILabel alloc] initWithFrame:CGRectMake(0, 14 *SIZE, 67 *SIZE, 11 *SIZE)];
    ...
    _dropImg = [[UIImageView alloc] initWithFrame:CGRectMake(67 *SIZE, 19 *SIZE, 7 *SIZE, 4 *SIZE)];
